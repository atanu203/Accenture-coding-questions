...
Input Specification: An integer N denoting the number of cuts.

Output Specification: Return the maximum number of pieces that can be obtained by making N cuts on the cake.
*/
